    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 15 }}>Profile complete</span>
        </div>
      ...
      <p style={{ margin: 0, color: '#ccc', lineHeight: 1.55, fontSize: 13 }}>
        Industry, department, and company size added to your profile. Piano enriches each
        reader's record progressively — no lengthy forms, no friction. The result is a
        rich first-party dataset that drives smarter targeting, better segmentation, and
