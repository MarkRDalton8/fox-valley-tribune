...
const BENEFITS = [
  ...
  'Local politics and election coverage',
    ...
    <>
      ...
      <div style={{ maxWidth: 620, margin: '0 auto', padding: '48px 20px' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 44, fontWeight: 700, color: COLORS.dark, margin: '0 0 16px', lineHeight: 1.2 }}>
            Stay Informed.<br />Stay Connected.
          </h1>
          <p style={{ fontSize: 16, color: '#555', lineHeight: 1.75, margin: 0 }}>
            The Fox Valley Tribune has covered this community since 1989. Your subscription keeps local reporters in the field and our neighbors informed.
          </p>
        </div>

        <div style={{ border: `2px solid ${COLORS.primary}`, borderRadius: 2, padding: '40px 48px', marginBottom: 24 }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <div style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 52, fontWeight: 700, color: COLORS.dark, lineHeight: 1 }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 32px' }}>
            {BENEFITS.map(b => (
              <li key={b} style={{ padding: '10px 0', borderBottom: `1px solid ${COLORS.border}`, fontSize: 15, color: '#333', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button onClick={handleSubscribe} style={{ width: '100%', background: COLORS.primary, color: 'white', border: 'none', padding: '16px', fontSize: 15, fontWeight: 800, cursor: 'pointer', letterSpacing: '1px', textTransform: 'uppercase' }}>
            Subscribe Now
          </button>
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: 13, color: '#999' }}>
          ...
          <button onClick={handleSignIn} style={{ background: 'none', border: 'none', color: COLORS.primary, cursor: 'pointer', fontSize: 13, padding: 0, textDecoration: 'underline' }}>
            Sign in here
          </button>
        </p>
      </div>
